    ...
    <main>
        <nav>
            <section class="nav-ctn">
                <ul>
                    <li><a href="prod.php">PRODUTOS</a></li>
                    <li><a href="shapes.php">SHAPES</a></li>
                    <li><a href="acess.php">ACESSÓRIOS</a></li>
                </ul>
            </section>
        </nav>
        <img src="imgprincipal.jpg" class="ctn-head">
        ...
        <div style="max-width: 1200px; margin: 0 auto; display: flex; justify-content: space-around; flex-wrap: wrap;">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <form action="#" method="post">
                    <wbr>
                    <ul>
                        <a href="cadastro.html" style="display: inline-block; padding: 10px 20px; background-color: #a71313; color: #333; text-decoration: none; border-radius: 5px; font-weight: bold;">
                            Cadastre-se
                        </a>
                    </ul>
                </form>
